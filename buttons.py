...
tarif_1 = InlineKeyboardButton('Неделя (1 ур.) - 150₽ 🦋', callback_data='level_1')
tarif_2 = InlineKeyboardButton('Месяц (2 ур.) - 500₽ 😇', callback_data='level_2')
tarif_3 = InlineKeyboardButton('Год (3 ур.) - 1500₽ 🤑', callback_data='level_3')
